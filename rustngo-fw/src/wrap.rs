/* These are a copy & paste of the wrappers from rustngo-lib.
 * Turns out they are also useful here in the firmware, but obviously
 * having this code duplication is no good, so will figure out a more elegant
 * way to share these wrappers.
 */
